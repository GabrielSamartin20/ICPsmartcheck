    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-16">
        <Tabs defaultValue="icp" className="space-y-8">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-5 h-auto bg-muted/50 p-1.5 gap-1">
            <TabsTrigger
              value="icp"
          ...
          <TabsContent value="concorrentes" className="space-y-6">
            ...
            <Card className="border-primary">
              ...
              <CardContent className="space-y-3">
                ...
                <p className="text-sm">
                  • <strong>Opções reais de parcelamento/assinatura</strong> local
                </p>
                <p className="text-sm">
                ...
                <p className="text-sm">
                  • <strong>Integração com postos de saúde</strong> locais (parcerias comunitárias)
                </p>
